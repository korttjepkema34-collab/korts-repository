...
2. Coder: also load `docs/09-godot-conventions.md` and `docs/18-godot4-cookbook.md`; work on a branch `coder/<task-id>-<slug>`; run the `godot-check` skill before finishing; never touch files outside `game/`.
